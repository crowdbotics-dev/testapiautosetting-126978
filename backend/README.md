...
## Project Structure
    ...
    ├── testapiautosetting_126978  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126978`
...
2. Clone this repo and `cd testapiautosetting_126978`
